    ...
    return (
        <div className="mt-6">
            ...
            <aside>
             ...
             <div><p className=" font-bold text-4xl">Rx_Property</p></div>
             </div>
              <div className=" space-y-2">
                <p className="flex items-center gap-1 text-base"><GoStopwatch></GoStopwatch> Sun - Sat 10.00- 18.00 Sunday CLOSED</p>
